# 🌊 Digispark Script - Chewbacca
- Completed On: February 1th 2023

### How to use:

- [Download](Chewbacca.ino) .ino file and [Chewbacca.wav](Chewbacca.wav), open this file in Arduino IDE and inject to Digispark ATtiny85.
